...
In order to compare the precesion of the different solutions we will use the relative error bwteen the numerical $v_i$ and analytical $f(x_i) solution as follow$
...
\section{Results}
  ...
  \begin{table}[H]
    ...
    $10^3$ & $\num{3.8e-5}$   & $\num{3.7e-5}$  & $\num{1.02e-2}$ \\ \hline
    $10^4$ & $\num{3.41e-4}$  & $\num{3.54e-4}$ & $\num{2.45e0}$ \\ \hline
    $10^5$ & $\num{3.79e-3}$  & $\num{3.50e-3}$ & N/A \\ \hline
    $10^6$ & $\num{3.57e-2}$  & $\num{3.24e-2}$ & N/A \\ \hline
    $10^7$ & $\num{3.16e-1}$  & $\num{3.24e-1}$ & N/A \\ \hline
    \end{tabular}
    \end{center}
    \label{tab:final_res}
  \end{table}
